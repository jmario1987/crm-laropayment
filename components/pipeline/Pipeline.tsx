...
            </div>
        )}
        {/* LÍNEA CORREGIDA: Cambiamos flex por grid y ajustamos las clases */}
...
                <div
                    key={stage.id}
                    // LÍNEA CORREGIDA: Eliminamos el ancho fijo y flex-shrink-0
                    className="pipeline-column flex flex-col bg-white dark:bg-gray-800 rounded-lg shadow-md transition-colors duration-300"
                    onDrop={(e) => handleDrop(e, stage.id)}
                    onDragOver={handleDragOver}
                    onDragEnter={(e) => handleDragEnter(e)}
                    onDragLeave={(e) => handleDragLeave(e)}
                >
                    <div className={`px-3 py-2 font-semibold text-lg text-gray-700 dark:text-gray-200 border-t-4 rounded-t-lg flex justify-between items-center`}
