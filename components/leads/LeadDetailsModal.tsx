...
    const { getUserById, products, getProviderById, getStageById } = useLeads();

    const handleEditSuccess = () => {
        setIsEditModalOpen(false);
        // No cerramos el modal principal para que el usuario vea los cambios
    };
    
...
                {/* CAMBIO AQUÍ: Añadimos clases para el scroll */}
