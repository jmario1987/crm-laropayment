...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  // --- REGRESAMOS A TUS COLORES DE MARCA PERO CON LA FORMA PREMIUM ---
  ...
  // Tu azul corporativo para el estado activo (respetando modo claro/oscuro)
  ...
  // Tu gris original para el estado inactivo
  ...
  return (
    <>
      ...
      {/* --- FONDO BLANCO ORIGINAL (Y MODO OSCURO) --- */}
