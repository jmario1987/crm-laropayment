      ...
      <div className="flex flex-col h-screen p-3 bg-white shadow w-60">
        <div className="space-y-3">
          ...
          <nav className="flex-1 p-4 space-y-2">
            ...
            {/* ¡Añadimos el nuevo enlace a Usuarios! */}
            <NavLink to="/users" className="flex items-center p-2 text-gray-700 rounded-lg hover:bg-gray-100">
               <NavIcon path="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" />
               <path d="M9 3a4 4 0 014 4v1a4 4 0 01-4 4H5a4 4 0 01-4-4V7a4 4 0 014-4h4zM23 21v-2a4 4 0 00-3-3.87" />
