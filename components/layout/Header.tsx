...
const Header: React.FC<HeaderProps> = ({ onNewLeadClick, userName, onLogout }) => {
  ...
  return (
    <>
      <header className="flex justify-between items-center h-20 px-6 bg-white dark:bg-gray-800 border-b dark:border-gray-700 flex-shrink-0">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative w-64" ref={searchContainerRef}>
              <input
                  ...
                  className="w-full px-4 py-2 text-sm text-gray-700 dark:text-gray-200 bg-gray-100 dark:bg-gray-700 border border-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500"
              />
          ...
          <div className="relative">
              <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="flex items-center space-x-2">
                  <span className="text-gray-700 dark:text-gray-300">Hola, {firstName}</span>
