export const COSTA_RICA_LOCATIONS: { [province: string]: { [canton: string]: string[] } } = {
    "San José": {
    ...
    "Alajuela": {
        ...
        "San Mateo": ["San Mateo", "Desamparados", "Jesús María", "Labrador"],
        "Atenas": ["Atenas", "Jesús", "Mercedes", "San Isidro", "Concepción", "San José", "Santa Eulalia", "Escobal"],
        "Naranjo": ["Naranjo", "San Miguel", "San José", "Cirí Sur", "San Jerónimo", "San Juan", "El Rosario", "Palmitos"],
        "Palmares": ["Palmares", "Zaragoza", "Buenos Aires", "Santiago", "Candelaria", "Esquipulas", "La Granja"],
        "Poás": ["San Pedro", "San Juan", "San Rafael", "Carrillos", "Sabana Redondo"],
    ...
    "Guanacaste": {
        ...
        "Cañas": ["Cañas", "Palmira", "San Miguel", "Bebedero", "Porrosatí"],
        "Abangares": ["Las Juntas", "Sierra", "San Juan", "Colorado"],
        "Tilarán": ["Tilarán", "Líbano", "Tierras Morenas", "Arenal"],
        "Nandayure": ["Carmona", "Santa Rita", "Zapotal", "San Pablo", "Porvenir", "Bejuco"],
        "La Cruz": ["La Cruz", "Santa Elena", "La Garita", "Santa Cecilia"],
